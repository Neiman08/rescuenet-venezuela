...
export const permissions = {
  ...
  VIEW_OPERATIONS_CENTER: "view_operations_center",
...
export const rolePermissions = {
  ...
  rescatista: [
    ...
    permissions.VIEW_OPERATIONS_CENTER,
    permissions.VIEW_RESCUED_PUBLIC,
  ],
  coordinador_rescate: [
    permissions.MANAGE_RESCUED,
  ...
  refugio: [permissions.MANAGE_CENTERS, permissions.MANAGE_LOGISTICS, permissions.MANAGE_RESCUED, permissions.VIEW_RESCUED_PUBLIC],
  hospital: [permissions.MANAGE_CENTERS, permissions.MANAGE_LOGISTICS, permissions.MANAGE_RESCUED, permissions.VIEW_RESCUED_PUBLIC],
  ong: [permissions.VIEW_DONATIONS, permissions.MANAGE_CENTERS, permissions.MANAGE_LOGISTICS],
