export const gisLayers = [
  ...
  { id: "incident_markers", label: "Reportes e incidentes", type: "point", source: "mockData.mapReports", status: "simulada", visible: true },
  { id: "shelters_hospitals", label: "Refugios y hospitales", type: "point", source: "mockData.centers", status: "simulada", visible: true },
