  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="card p-6 grid md:grid-cols-2 gap-4">
        ...
        <button className="btn bg-rescueGreen text-white md:col-span-2 flex items-center justify-center gap-2"><CheckCircle size={20} /> Confirmar que estoy a salvo</button>
      </div>
    </div>
  );
}
